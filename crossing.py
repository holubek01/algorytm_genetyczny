...
def crossing(tour1, tour2):
    ...
    c4 = Creature(id_counter, tour4, destination(sizeTab, matr, tour4), 0, 0)
    c5 = Creature(id_counter + 1, tour5, destination(sizeTab, matr, tour5), 0, 0)
...
def main():
    ...
    for i in range(population_size - 1):
        ...
        c = Creature(i, tour, destination(sizeTab, matr, tour), 0, 0)
    ...
    island.creatures.append(Creature(population_size - 1, last_child, destination(sizeTab, matr, last_child), 0, 0))
...
def generation(island):
    ...
    sorted_by_fenotype = sorted(crossed_creatures, key=lambda x: x.fenotyp, reverse=True)
...
def crossingPMX(parent1, parent2):
    ...
    global id_counter
    c4 = Creature(id_counter, child1, destination(sizeTab, matr, child1), 0, 0)
    c5 = Creature(id_counter + 1, child2, destination(sizeTab, matr, child2), 0, 0)
    id_counter += 2
